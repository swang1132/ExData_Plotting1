...
##
## Step 4 - Plotting the first plot - historgram
##
png(filename = "./figure/plot1.png", width = 480, height = 480, units = "px", pointsize = 12)
hist(selectedConsumption$Global_active_power, col = "red", main = "Global Active Power", 
     xlab = "Global Active Power (kilowatts)", freq = T)
dev.off()